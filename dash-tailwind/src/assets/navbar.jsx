...
function Navbar() {
  ...
  return (
    <>
      <nav className="border-b border-b-gray-950 p-4 w-screen bg-white font-semibold lg:overflow-x-hidden hidden sm:block dark:bg-black">
      ...
      <nav className="shadow-md  w-screen bg-white font-semibold lg:overflow-x-hidden sm:hidden block dark:bg-black">
